...
class MonitoringModel extends CI_Model
{
    ...
    function GetRoleDopDown()
    {
        return $this->db->get('roles_monitoring')->result();
    }
    ...
    function GetUser($draw, $start, $length, $search, $order)
    {
        ...
        if ($search['value'] != null || $search['value'] != '') {
            $this->db->like('user_monitoring.USERNAME', $search['value']);
    ...
    function InsertDataUser($input)
    {
        $data = [
            'USER_ID' => $this->gen_uuid(),
            'USERNAME' => htmlspecialchars($input['userName']),
            'PASSWORD' => password_hash(
                htmlspecialchars($input['password']),
                PASSWORD_DEFAULT
            ),
            'ROLE_ID' => htmlspecialchars($input['roleId']),
            'MECHINE_ID' => htmlspecialchars($input['machineId']),
        ];
        if ($this->db->insert('user_monitoring', $data)) {
            return true;
        }
        return false;
    }
